...
def main():
    ...
    print(">>> localizer.get_current_language()")
    current_lang = localizer.get_current_language()
    print(f"'{current_lang}'")
    print(">>> localizer.get_available_languages()")
    ...
    print(">>> localizer.get_text('user_greeting', username='John', count=5)")
    ...
    print(">>> localizer.get_text('this_key_does_not_exist')")
